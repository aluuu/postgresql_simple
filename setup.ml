...
(* OASIS_START *)
(* DO NOT EDIT (digest: fd977637cf5f4ac8ffe3434cff9ebba4) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "postgresql_simple";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "postgresql_simple"
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\026\225\252\164R\1950\209\1305\127\223\015S4\184";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
